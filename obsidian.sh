...
repoReleaseURL="https://github.com/obsidianmd/obsidian-releases/releases"
latestReleaseURL=$(/usr/bin/curl -sfL "${repoReleaseURL}" | /usr/bin/tr '"' "\n" | /usr/bin/grep -i "expanded_assets" | /usr/bin/head -1)
